...
$(function ($) {
   ...
   ==========================*/
    ...
    if ($("#hero-slider").length > 0) {
        ...
        $("#hero-slider .owl-dots").wrap(
            '<div class="container slider-dot-item"><div class="row"><div class="col-lg-9"></div></div></div>'
        );
        $("#hero-slider .owl-nav").wrap(
            '<div class="container slider-arrow-item"><div class="row"><div class="col-lg-9"></div></div></div>'
        );
    }
    /* ----------------------------------------------------------- */
    /*  post slider
